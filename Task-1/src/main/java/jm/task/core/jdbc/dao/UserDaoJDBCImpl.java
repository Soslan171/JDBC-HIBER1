...
public class UserDaoJDBCImpl implements UserDao {
    ...
    public void dropUsersTable() {
        ...
        String sql = "DROP TABLE IF EXISTS postgres.public.users";
    ...
    public void saveUser(String name, String lastName, byte age) {
        ...
        String sql = "INSERT INTO postgres.public.users (NAME, LASTNAME, AGE) VALUES (?, ?, ?)";
    ...
    public void removeUserById(long id) {
        ...
        String sql = "DELETE FROM postgres.public.users WHERE ID = ?";
    ...
    public List<User> getAllUsers() {
        ...
        String sql = "SELECT * FROM postgres.public.users";
    ...
    public void cleanUsersTable() {
        ...
        String sql = "DELETE FROM postgres.public.users";
